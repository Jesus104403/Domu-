            ...
            <td class="p-4">
                 <div class="flex items-center justify-center gap-2">
                    ...
                    <?php if(strtolower($prop['estado']) == 'pendiente'): ?>
                        <a href="../apis/api_aprobar_propiedad.php?id=<?php echo $prop['id']; ?>" 
                        title="Aprobar"
                        class="flex items-center gap-1 bg-green-50 text-green-700 hover:bg-green-500 hover:text-white px-3 py-1.5 rounded-lg text-xs font-bold transition-all border border-green-200 hover:border-green-500 shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            Aprobar
                        </a>
                        
                        <a href="../apis/api_rechazar_propiedad.php?id=<?php echo $prop['id']; ?>" 
                        onclick="return confirm('¿Estás seguro de rechazar esta propiedad?')"
                        title="Rechazar"
                        class="flex items-center gap-1 bg-red-50 text-red-700 hover:bg-red-500 hover:text-white px-3 py-1.5 rounded-lg text-xs font-bold transition-all border border-red-200 hover:border-red-500 shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                            Rechazar
                        </a>
                        
                        <div class="w-px h-6 bg-gray-200 mx-1"></div> <?php endif; ?>

                    <button class="text-indigo-600 hover:text-indigo-900 font-bold text-sm px-2 transition-colors">Editar</button>
